...
export const handleImageUpload = async (
  ...
  // Une Server Action ne donne pas de progression granulaire (pas de
  // XHR/fetch stream sous-jacent exposé), on simule juste un signal
  // de démarrage puis de fin pour que la barre de progression bouge.
