...
export default function SignInPage() {
  ...
  return (
    <AuthShell>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <div className="mb-2 flex items-center justify-between">
            <label
              htmlFor="password"
              className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#6B7280]"
            >
              Mot de passe
            </label>
            <Link
              href="/forgot-password"
              className="text-[11px] text-[#6B7280] transition-colors hover:text-[#1C1C1E]"
            >
              Oublié ?
            </Link>
          </div>
      ...
      <div className="my-6 flex items-center gap-3">
        <div className="h-px flex-1 bg-[#1C1C1E]/8" />
        <span className="text-[11px] text-[#6B7280]">pas encore inscrit ?</span>
        <div className="h-px flex-1 bg-[#1C1C1E]/8" />
      </div>
